...
export default function Home() {
  ...
  return (
    <div className="flex w-full h-screen justify-center lg:items-center bg-magnolia">
      {/* Desktop */}
      <div className="hidden lg:flex h-[80%] p-4 rounded-md bg-white">
      ...
      {/* Mobile */}
      <div className="flex lg:hidden wfull">
        <div className="flex flex-col w-full relative">
          <Image
            ...
            height={1000}
          />
          <div className="flex h-full w-full flex-col px-6 py-8 absolute">
              ...
              <div
                className={`${
                  step === 1
                    ? "bg-lightBlue border-lightBlue"
                    : "border-white text-white"
                } flex aspect-square justify-center items-center w-8 rounded-full font-[700] text-[18px] border border-white`}
              >
                1
              </div>
              <div
            ...
            {/* Steps */}
            <div className="flex flex-col p-6 mt-8 bg-white rounded-lg shadow">
              {step === 1 && (
                <Step1
                  name={name}
                  setName={setName}
